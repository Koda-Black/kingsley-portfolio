...
export const metadata = createPageMetadata({
  title: "Contact — Work With Kingsley Onuorah",
  description: "Contact Kingsley Onuorah for fullstack engineering, AI product development, technical leadership and technology venture opportunities.",
  path: "/contact",
});
