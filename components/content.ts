...
export const projects: Project[] = [
  ...
  { name: "Ajo Cash", eyebrow: "Digital trust infrastructure", description: "Digital infrastructure for Nigerian rotating savings groups with automatic contributions, instant payouts and AI-powered trust.", image: "/projects/ajo-cash.jpg", url: "https://www.ajo.cash", stack: ["Fintech", "Savings", "Trust infrastructure"], tone: "purple" },
  { name: "Jeje Limited", eyebrow: "Bakery storefront", description: "A vibrant digital storefront for Nigerian bread and confectioneries, featuring an interactive product carousel, menu and shopping cart.", image: "/projects/jeje-limited.jpg", url: "https://www.jejelimited.com", stack: ["E-commerce", "Food & beverage", "Interactive design"], tone: "coral" },
  { name: "GB Interiors", eyebrow: "Interior design", description: "A premium digital showcase for bespoke interiors, made-to-measure furniture and project delivery across Nigeria.", image: "/projects/gb-interiors.jpg", url: "https://www.gbinteriors.ng", stack: ["Interior design", "Furniture", "Portfolio"], tone: "yellow" },
